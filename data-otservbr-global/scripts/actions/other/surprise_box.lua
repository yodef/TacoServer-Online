local prize = {
	...
	[3] = { chance = 3, id = 9019, amount = 1 },
	[4] = { chance = 4, id = 3549, amount = 1 },
	[5] = { chance = 5, id = 3420, amount = 1 },
	[6] = { chance = 10, id = ITEM_CRYSTAL_COIN, amount = 25 },
	[7] = { chance = 20, id = ITEM_PLATINUM_COIN, amount = 10 },
	[8] = { chance = 30, id = ITEM_CRYSTAL_COIN, amount = 10 },
	[9] = { chance = 40, id = ITEM_PLATINUM_COIN, amount = 50 },
	[10] = { chance = 50, id = ITEM_PLATINUM_COIN, amount = 30 },
	[11] = { chance = 80, id = ITEM_PLATINUM_COIN, amount = 80 },
}
