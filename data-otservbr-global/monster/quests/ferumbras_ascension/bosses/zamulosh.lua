...
monster.defenses = {
	...
	armor = 30,
	--	mitigation = ???,
	{ name = "combat", interval = 1000, chance = 50, type = COMBAT_HEALING, minDamage = 220, maxDamage = 535, effect = CONST_ME_YELLOW_RINGS, target = false },
	{ name = "zamulosh invisible", interval = 8000, chance = 25 },
